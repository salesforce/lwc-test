...
import FooTs from 'example/fooTs';
import Bar from 'other/bar';

jest.mock('globalLib', () => {
    return {
        func: () => 'from fooTs.test.js',
    };
});
...
describe('example-foo', () => {
    ...
    it('should render correct snapshot', () => {
        const element = createElement('example-foo', { is: FooTs });
    ...
    it('returns value on inner element from mock defined in test file', () => {
        ...
        expect(inner.globalLibReturn).toBe('from fooTs.test.js');
    });
});
