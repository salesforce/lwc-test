...
/*
 * A3 — mirrors jest-transformer/src/transforms/__tests__/user-permission-scoped-import.test.js.
...
describe('@salesforce/userPermission import', () => {
    test('does default transformation', '@salesforce/userPermission/foo', 'foo');
});
