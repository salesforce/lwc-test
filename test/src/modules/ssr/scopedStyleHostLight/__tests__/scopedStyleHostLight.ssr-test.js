...
it('renders a basic component with scoped styles, light DOM with :host', () => {
    ...
    expect(renderedComponent).toMatchInlineSnapshot(`<x-scoped-style class="lwc-3nvo014iss4-host"><style class="lwc-3nvo014iss4" type="text/css">h1.lwc-3nvo014iss4 {color: red;}.lwc-3nvo014iss4-host {color: blue;}</style><h1 class="lwc-3nvo014iss4">Scoped style test</h1></x-scoped-style>`);
});
